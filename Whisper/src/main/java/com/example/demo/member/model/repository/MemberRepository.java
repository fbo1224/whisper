...
public interface MemberRepository extends JpaRepository<Member, Integer>{
	...
	@Query("SELECT m, p FROM Member m LEFT JOIN MemberProfile p ON m.memNo = p.memNo WHERE m.memId = :memId AND m.memPwd = :memPwd")
    Member findMemberWithProfile(@Param("memId") String memId, @Param("memPwd") String memPwd);
